...
async function formatSongs(songs : Song[] , setList: (list: Song[]) => void) {
  ...
  return result.responseMap.songs.map((mapSong : { [key: string]: any }) => {
      ...
      const spotify: string = "https://open.spotify.com/track/3Z2y6rX1dZCfLJ9yZGzQw5" // TODO: ask and fix what this does

      return { name: name, cover : cover, artist: artist, blob: blob, spotify: spotify };
    })
}
